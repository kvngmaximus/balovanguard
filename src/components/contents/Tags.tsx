...
import { demoCategories } from '@/lib/blogs';
...
const Tags = () => {
    ...
    useEffect(() => {
        // Use local demo categories and wrap to mimic GraphQL edges
        const edges = demoCategories.map((cat) => ({ node: cat }));
        setTags(edges as any);
        setIsLoading(false);
    }, []);
