    ...
    return (
        <AnimationContainer customClassName='w-full py-12 lg:py-16'>
            ...
            <p className='mb-4 text-justify lg:leading-7 text-neutral-200 lg:text-start'>
                A creative problem solver with over 4 years of design experience and 2 years of programming experience, I&apos;ve explored diverse programming languages, libraries, and technology stacks, honing my skills in both Design, Frontend, Backend, and App development.
            </p>
